                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th ng-click="sort('value')" class="cursor-pointer">{{ trans('list.massType') }}
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content border-radius">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" ng-if="!newData.id">Add New Mass Type</h4>
                            </div>
                            <div class="modal-body">
                                <form ng-submit="submitForm()" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="value" ng-model="newData.value" placeholder="Mass Type Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
