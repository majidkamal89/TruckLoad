...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b>Lass.no</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">{{trans('list.signInMessage')}}</p>
        ...
        <form class="form-horizontal" id="loginform" role="form" method="POST" action="{{ route('login') }}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> {{trans('list.rememberMe')}}
                        </label>
                    </div>
                </div>
